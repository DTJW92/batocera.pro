...
wget https://github.com/DTJW92/batocera.pro/raw/main/PSXDownloader/PSXDownloader.sh.keys -P /userdata/roms/ports/
...
mv /userdata/roms/ports/PSXDownloader.sh.keys /userdata/roms/ports/PSXDownloader.sh.keys
