...
curl -L https://github.com/DTJW92/batocera.pro/raw/main/PSXDownloader/psxd.sh -o /userdata/system/pro/psxd.sh

# Download BatoceraPRO.sh to /userdata/roms/ports
curl -L https://github.com/DTJW92/batocera.pro/raw/main/PSXDownloader/PSXD.sh -o /userdata/roms/ports/PSXD.sh
...
chmod +x /userdata/system/pro/psxd.sh
chmod +x /userdata/roms/ports/PSXD.sh
...
mv /userdata/roms/ports/bkeys.txt /userdata/roms/ports/PSXD.sh.keys
