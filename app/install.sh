...
curl -L https://github.com/DTJW92/batocera.pro/raw/main/app/pro.sh -o /userdata/system/pro/pro.sh

# Download BatoceraPRO.sh to /userdata/roms/ports
curl -L https://github.com/DTJW92/batocera.pro/raw/main/app/BatoceraPRO.sh -o /userdata/roms/ports/BatoceraPRO.sh

# Download BatoceraPRO.sh.keys to /userdata/roms/ports
wget  https://github.com/DTJW92/batocera.pro/raw/main/app/bkeys.txt -P /userdata/roms/ports/
